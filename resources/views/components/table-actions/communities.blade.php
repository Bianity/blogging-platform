<div class="flex items-center gap-x-5">
    <a href="{{ route('admin.communities.edit', $row) }}" title="{{ __('Edit') }}">
    ...
    <button
        title="{{ __('Delete') }}"
        x-on:confirm="{
					title: '{{ __('Delete Community?') }}',
					description: '{{ __('Are you sure you want to delete this community? This action will erase entry.') }}',
					icon: 'error',
